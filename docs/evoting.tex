...
\declaration{V~Praze dne 26.\,5.\,2011}
...
Stejným způsobem jsem změnil i výběr neukončených volebních událostí, které se vybíraly zcela neefektivně - položil se dotaz na databázi pro výběr všech událostí, přes ty se následně iterovalo a hledaly se ty, které měly příznak \uv{finished} na hodnotě \uv{false}.
